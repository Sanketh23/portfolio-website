  ...
  <div>
    ...
    <div class="container">
      <div class="full-title">
        <div class="profile">
          <img src="me.jpg" class="profile-pic" alt="Sanketh Edara" />
        </div>
        <h1
          id="typing-title"
          class="display-4"
        ...
        <div>
          ...
          •
          <span>
            <a target="_blank" href="https://github.com/sanketh23/">GitHub</a>
          </span>
          •
          <span>
            <a target="_blank" href="https://www.linkedin.com/in/sedara05/"
              >LinkedIn
            </a>
          </span>
        </div>
